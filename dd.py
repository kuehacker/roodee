...
botStart = time.time()
#==============================================================================#
line = LINE("EulqPkiswzVk58z5jni2.UFiDv4wzC+32+NvqOcnm0G.Kl7ld9tMAG1vW+QV4apL0gxUth4XiXOX6T1utYtIPTQ=")
...
RfuBot=[lineMID]
Family=["ub9f21d57859973fdf6fe7550a0234cd2",lineMID]
admin=['ub9f21d57859973fdf6fe7550a0234cd2',lineMID]
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, " sellbotkue  ")
                    elapsed_time = time.time() - start
                    line.sendMessage(to,format(str(elapsed_time)))	
                elif text.lower() == 'sp':
                    start = time.time()
                    line.sendMessage(to, "   sellbotkue️ ")
                    elapsed_time = time.time() - start
                    line.sendMessage(to,format(str(elapsed_time)))						
                elif text.lower() == 'รีบูส':
                    line.sendMessage(to, "กรุณาตั้งค่าระบบใหม่.")
...
#===================================================================#              
                    ...
                    line.sendMessage(msg.to,"   sellbotkue️")
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งข้อความคนเข้าเรียบร้อยแล้ว")
                          ...
                          line.sendMessage(msg.to, "sellbotkue\n\n\n{}".format(str(spl)))
